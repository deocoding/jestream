...
!(function (t, e) {
    ...
    var Oe = {
        modes: {
            ...
            nearest: (t, e, i, n) =>
                De(t, Me(e, t), i.axis || "xy", i.intersect, n),
    ...
    function ci(t, e, i) {
        i && i.disconnect(),
            "resize" === e &&
                (function (t) {
                    si.delete(t),
                        si.size || window.removeEventListener("resize", ri);
                })(t);
    }
    function hi(t, i, n) {
        const o = t.canvas,
    ...
    class Li {
        ...
        _resolveElementOptions(t, e = "default", i) {
            ...
            return (
                g.$shared &&
                    ((g.$shared = l), (s[a] = Object.freeze(Ri(g, l)))),
                g
            );
        }
    ...
    function Yn(t, e) {
        return (
            "top" === t || "bottom" === t || (-1 === $n.indexOf(t) && "x" === e)
        );
    }
    function Un(t, e) {
        return function (i, n) {
        ...
        _initialize() {
            ...
            return (
                ...
                t.options.responsive
                    ? t.resize()
                    : ye(t, t.options.devicePixelRatio),
                t.bindEvents(),
            ...
            i &&
                ...
                J(s, (i) => {
                    const s = i.options,
                        ...
                        l = K(s.type, i.dtype);
                    (void 0 !== s.position &&
                        Yn(s.position, r) === Yn(i.dposition)) ||
                ...
                { circumference: h, rotation: d } = e._getRotationExtents(),
                {
                    ...
                    if (e < _t) {
                        const r = t,
                            ...
                            u = Math.sin(l),
                            f = (t, e, n) =>
                                Ht(t, r, l) ? 1 : Math.max(e, e * i, n, n * i),
                            g = (t, e, n) =>
                        ...
                        (s = u
                            ? Nt(
                                  Math.max(
                                      ...
                                      i
                                          ? 0
                                          : oe(e, l, a.getPixelForValue(h)).hi +
                                                1
                                  ),
                                  o,
                                  n
                ...
                (t.fillStyle = i.backgroundColor),
                    ...
                    (function (t, e) {
                        ...
                        isNaN(e.circumference) ||
                            (e.endAngle =
                                e.startAngle + (e.circumference % _t)),
                            wo(t, e),
                            t.fill();
                    })(t, e),
                    Mo(t, e),
    ...
    class Lo extends Ei {
        ...
        get segments() {
            return (
                this._segments ||
                (this._segments = kn(this, this.options.segment))
            );
        }
        first() {
    ...
    var ds = {
        ...
        afterDatasetsUpdate(t, e, i) {
            ...
            for (a = 0; a < n; ++a)
                (l = o[a]),
                    l && !1 !== l.fill && (l.fill = ns(o, a, i.propagate));
        },
        beforeDraw(t, e, i) {
    ...
    class Cs extends Ei {
        ...
        getTitle(t, e) {
            ...
            let r = [];
            return (
                (r = bs(r, _s(o))), (r = bs(r, _s(s))), (r = bs(r, _s(a))), r
            );
        }
        getBeforeBody(t, e) {
            ...
            return (
                ...
                null === t || isNaN(t)
                    ...
                    : e.getPixelForDecimal(
                          t === e.min
                              ? 0
                              : (Pt(t) - e._startValue) / e._valueRange
                      )
            );
        }
        getValueForPixel(t) {
            ...
            return (
                ...
                (t._majorUnit =
                    n.major.enabled && "year" !== t._unit
                        ? (function (t) {
                              for (
                                  let e = Ys.indexOf(t) + 1, i = Ys.length;
                                  e < i;
                                  ++e
                              )
