document.addEventListener("DOMContentLoaded", () => {
    ...
    if (((t = document.getElementById("sortable-style-2")), t)) {
        Sortable.create(t, { handle: ".handle", animation: 150 });
    }
    ...
    animateCSS = (t, e, o = "animate__") =>
        new Promise((a, r) => {
            ...
            n.addEventListener(
                ...
                (t) => {
                    t.stopPropagation(),
                        n.classList.remove(o + "animated", o + "faster", i),
                        a("Animation Ended.");
                },
                { once: !0 }
            );
...
if ((cards(), "undefined" != typeof Chart)) {
    ...
    (t.id = "lineWithShadowElement"), Chart.register(t);
    class e extends Chart.controllers.line {}
    (e.id = "lineWithShadow"),
        (e.defaults = { datasetElementType: "lineWithShadowElement" }),
        Chart.register(e);
    ...
    (o.id = "barWithShadow"), Chart.register(o);
    ...
    (r.id = "doughnutWithShadow"),
        (r.defaults = { datasetElementType: "lineWithShadowElement" }),
        Chart.register(r);
    class i extends Chart.controllers.radar {}
    (i.id = "radarWithShadow"),
        (i.defaults = { datasetElementType: "lineWithShadowElement" }),
        Chart.register(i);
    ...
    (s.id = "lineWithAnnotation"), Chart.register(s);
...
const customizer = () => {
    const t = () => {
        ...
        if (t) {
            const e = localStorage.getItem("dir");
            if (e) {
                document.dir = e;
                const o = t.querySelector('[data-toggle="rtl"]');
                o.checked = "rtl" === e;
            }
            const o = localStorage.getItem("scheme");
            if (o) {
                const e = t.querySelector('[data-toggle="darkMode"]');
                e.checked = "dark" === o;
            }
            let a = localStorage.getItem("menuType");
            if (a) {
                a = a.replace("menu-", "");
                t.querySelector("[data-value='" + a + "']").checked = !0;
            }
        }
    };
    on("#customizer", "click", '[data-toggle="darkMode"]', () => {
        ...
        on("body", "click", '[data-toggle="customizer"]', () => {
            (() => {
                ...
                t.classList.contains("open")
                    ? (t.classList.remove("open"), hideOverlay())
                    : (t.classList.add("open"), showOverlay());
            })();
        }),
        t();
};
...
if ((darkMode(), "undefined" != typeof Chart)) {
    ...
    if (((o = document.getElementById("visitorsChart")), o)) {
        ...
        a.addColorStop(0, "rgba(" + t.primary + ", .5)"),
            a.addColorStop(0.75, "rgba(" + t.primary + ", 0)"),
            new Chart(o, {
                type: "lineWithShadow",
                data: {
                    labels: [
                    ...
                    datasets: [
                        {
                            data: [
                                6.25, 7.5, 10, 7.5, 10, 12.5, 10, 12.5, 10,
                                12.5, 15, 16.25,
                            ],
                ...
                options: {
                    plugins: { legend: { display: !1 }, tooltip: e },
                    scales: {
                        y: {
            ...
            plugins: {
                ...
                tooltip: {
                    ...
                    external: (t) => {
                        ...
                        (e.querySelector(".chart-heading").innerHTML = a),
                            (e.querySelector(".chart-value").innerHTML =
                                "$" + o),
                            (e.querySelector(".chart-label").innerHTML = r);
                    },
                },
...
const fullscreen = () => {
    ...
    on("body", "click", "#fullScreenToggler", () => {
        ...
        document.msFullscreenElement
            ...
            t.classList.contains("la-expand-arrows-alt")
                ? (t.classList.remove("la-expand-arrows-alt"),
                  t.classList.add("la-compress-arrows-alt"))
                : (t.classList.remove("la-compress-arrows-alt"),
                  t.classList.add("la-expand-arrows-alt"));
    });
};
fullscreen();
const menu = () => {
    ...
    document.addEventListener("click", (t) => {
        t.target.closest(".menu-items a") ||
            t.target.closest(".menu-detail") ||
        ...
        on(".menu-items", "click", ".link", (t) => {
            const e = t.target.closest(".link").dataset.target,
                a = o.querySelector(e);
            o.classList.contains("menu-wide") ||
                (a ? (showOverlay(!0), a.classList.add("open")) : hideOverlay(),
                r(),
                a ? (showOverlay(!0), a.classList.add("open")) : hideOverlay());
        });
    ...
    const i = (e) => {
            ...
            switch (
                ...
                case "hidden":
                    ...
                    break;
                default:
                    localStorage.removeItem("menuType"), a && showOverlay(!0);
            }
        },
        n = () => {
            ...
            t.classList.remove("menu-wide"),
                ...
                o.querySelectorAll(".menu-items .link").forEach((t) => {
                    ...
                    r &&
                        ...
                        t.removeAttribute("data-toggle", "collapse"),
                        a.after(r));
                });
        };
    o.classList.contains("menu-wide") && n(),
        on(".menu-bar", "click", "[data-toggle='menu-type']", (t) => {
            const e = t.target.closest("[data-toggle='menu-type']").dataset
                .value;
            i(e);
        }),
...
const showOverlay = (t) => {
        ...
        t
            ? e.setAttribute("class", "overlay workspace")
...
const showPassword = () => {
    on("body", "click", '[data-toggle="password-visibility"]', (t) => {
        ((t) => {
            ...
            "password" === e.type
                ? ((e.type = "text"),
                  t.classList.remove("text-gray-600", "dark:text-gray-600"),
                  t.classList.add("text-primary", "dark:text-primary"))
                : ((e.type = "password"),
                  t.classList.remove("text-primary", "dark:text-primary"),
                  t.classList.add("text-gray-600", "dark:text-gray-600"));
...
const sidebar = () => {
    on("body", "click", '[data-toggle="sidebar"]', () => {
        (() => {
            ...
            t.classList.contains("open")
                ? (t.classList.remove("open"), hideOverlay())
                : (t.classList.add("open"), showOverlay(!0));
        })();
    });
};
sidebar();
const tabs = () => {
    ...
    on("body", "click", '[data-toggle="tab"]', (e) => {
        const o = e.target.closest('[data-toggle="tab"]'),
            ...
            i = a.querySelector(".collapse.open"),
            n = a.querySelector(o.dataset.target);
        t ||
            (r !== o &&
        ...
        on("body", "click", '[data-toggle="wizard"]', (t) => {
            const e = t.target.closest(".wizard"),
                ...
                a = e.querySelectorAll(".nav-link"),
                r = e.querySelector(".nav-link.active");
            let i = 0;
            switch (
                (a.forEach((t, e) => {
                    t === r && (i = e);
...
const customTippy = () => {
    tippy.delegate("body", {
        ...
        tippy('[data-toggle="popover"]', {
            ...
            content: (t) =>
                "<h5>" +
                t.dataset.popoverTitle +
                '</h5><div class="mt-5">' +
                t.dataset.popoverContent +
                "</div>",
        }),
